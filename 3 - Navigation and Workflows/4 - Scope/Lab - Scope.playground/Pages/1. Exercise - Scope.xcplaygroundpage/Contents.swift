...
//print("The value of foo is \(foo)")
print("Yes compiler error will be generated")
...
print("it will generate no error as x is a global variable")
...
greeting(greeting: nil, name: "Tanish")
greeting(greeting: "hello,", name: "Tanish")
