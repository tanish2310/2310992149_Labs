...
struct User {
    ...
    {
        print("Existing user is ", User.currentUser)
    }
}

let name1 = User(username: "Tanish", email: "tanish@chitkara.edu.in", age: 20)
...
let newUser = User(userName: "Alice", email: "alice@example.com", age: 28)
