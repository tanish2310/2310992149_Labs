...
let somePlace = GPS(longitude: 0.125226, latitude: 51.514004)
print(somePlace)
...
struct Book {
    ...
    let favoriteBook = Book(title: "Srounded by Idiots", author: "Thomas Erikson", pages: 300, price: 499.99)
print(favoriteBook)
...
let ROG_Strix = Laptop(screenSize: 15, yearPurchase: 2023)
let Mac_Book_Air = Laptop(yearPurchase: 2025)
